...
**Estilo**: ilustración vectorial plana de personajes, cálida y amigable (piensa en packs de ilustración tipo Storyset/Blush/unDraw), NO fotorrealista. Ojos simples tipo punto, sonrisas simples, formas redondeadas, contornos limpios. Un poco de sombra plana de un solo tono por color para dar profundidad (sin degradados). Tonos de piel y cabello variados/diversos (esto no se restringe a la paleta de marca); la ropa y accesorios sí pueden usar los colores de marca (morado #6C4FD6 / #4E36A8, verde #38B36B / #279250) para mantener consistencia visual con el resto del sitio.

**Bloque de estilo maestro para personajes (pegar al inicio de cada prompt):**
```
Flat vector character illustration in a warm, friendly children's-illustration style (similar to modern flat illustration packs like Storyset or Blush), NOT photorealistic, NOT 3D render. Simple dot eyes, simple smiling mouths, soft rounded shapes, clean bold outlines, flat coloring with one soft shadow tone per color for subtle depth (no gradients, no harsh shading). Diverse, warm and varied skin tones and hair. Clothing/accessories may use these brand accent colors: purple #6C4FD6, green #38B36B. Transparent or plain white background. No text, no logos, no watermarks in the image.
```
